...
# Load the pre-trained model and tokenizer for English to Hinglish translation
...
while True:
    ...
    english_statement = input("Enter an English statement (or type 'exit' to quit): ")
    ...
    print("Translation:", hinglish_translation)
